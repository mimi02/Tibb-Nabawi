...
function searchConcepts($sparql, $keyword){
    ...
    foreach($isIllness as $illness){
        $label = stripOntologyNamespace($illness->class);//cleanQuery
           ?>
      ...
      <?php  // echo(' '. $label."\n<br>"); ?>
         ...
         $mtreats = getIllnessTreatmentByClassName($sparql, $label, $modern_treatment_class_name);
         $ptreats = getIllnessTreatmentByClassName($sparql, $label, $prophet_treatment_class_name);
        // echo "$treats";
